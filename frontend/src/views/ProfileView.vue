...
const allBadges = ref([
  ...
  { id: 4, name: 'Dolce Frutto', icon: 'fa-solid fa-apple-whole', color: 'linear-gradient(135deg, #fcd34d, #d97706)', isLocked: false },
  { id: 5, name: 'Nuovo Nido', icon: 'fa-solid fa-egg', color: 'linear-gradient(135deg, #fb923c, #c2410c)', isLocked: false },
  { id: 6, name: 'Primo Volo', icon: 'fa-solid fa-feather-pointed', color: 'linear-gradient(135deg, #7dd3fc, #0284c7)', isLocked: false },
  { id: 7, name: 'Guardiano del Nido', icon: 'fa-solid fa-shield-halved', color: 'linear-gradient(135deg, #fef08a, #b45309)', isLocked: false, isGiant: true }
])
...
.bio-text { color: #52796f; font-style: italic; margin-bottom: 15px; font-size: 15px; }
...
.edit-profile-btn { margin-bottom: 25px; }
